...
{
    protected $mchid = '1508534671';
    protected $appid = 'wxe58eeb9048a331f8';
    protected $appKey = '7AeYbZHIT4vMNpilmI15elP12NDeUY0TUgcLs0esPW2';
    protected $apiKey = 'nord@Drivesystem2shixiaoxia1234AB';
    protected $apiclient_cert = '/www/html/jue/nord/apiclient_cert.pem';
    protected $apiclient_key = '/www/html/jue/nord/apiclient_key.pem';
    public $data = null;
